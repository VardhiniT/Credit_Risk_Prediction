...
The goal of this project is to predict whether a mortgage-backed security (MBS) will become delinquent using borrower and loan-level data.
...
PCA helps improve stability in multicollinear data
🛠️ Technologies Used
Python
Pandas
NumPy
